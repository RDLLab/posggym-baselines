"""Tests for planning.mcts.tree using random policies."""
import math

import posggym
import posggym.agents as pga

from posggym_baselines.planning.mcts.tree import POMMCPConfig, POMMCP
...
search_policy = RandomSearchPolicy(env.model, planning_agent_id, "random")
planner_other_policy = RandomOtherAgentPolicy(env.model, other_agent_id, "random")
...
true_other_policy = pga.make("Random", env.model, other_agent_id)
